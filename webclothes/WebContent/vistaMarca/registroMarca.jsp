...
<div class="row pt-5">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-5">
    <input type="text" class="form-control" value="<c:out value='${marca.nombre}'/>"  name="nombre" id="InputNombre">  
    </div>
    
  </div>
  <div class="form-group row" >
    <label for="InputNombre" class="col-sm-2 col-form-label">Descripcion</label>
    <div class="col-sm-5">
     <input type="text" class="form-control" value="<c:out value='${marca.descripcion}'/>"  name="descripcion" id="InputDescripcion">  
    </div>
