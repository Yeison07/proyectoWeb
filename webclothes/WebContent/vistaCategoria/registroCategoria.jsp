...
<div class="row pt-5">
  ...
  <c:if test="${categoria!=null}">
    ...
    <div class="col-sm-5">
    <input type="text" class="form-control" value="<c:out value='${categoria.id}'/>"  name="id" id="InputReferencia">  
    </div>
    
  </div>
  <div class="form-group row">
    <label for="InputReferencia" class="col-sm-2 col-form-label">Descripcion</label>
    <div class="col-sm-5">
    <input type="text" class="form-control" value="<c:out value='${categoria.descripcion}'/>"  name="descripcion" id="InputReferencia">  
    </div>
  ...
  <div class="form-group row" >
    ...
    <div class="col-sm-5">
     <input type="text" class="form-control" value="<c:out value='${categoria.estado}'/>"  name="estado" id="InputEstado">  
    </div>
