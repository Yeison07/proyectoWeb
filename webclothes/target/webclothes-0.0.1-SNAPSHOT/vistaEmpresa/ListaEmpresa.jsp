...
<div class="row justify-content-center pt-2">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col"id="tabla_col_3">Quienes somos</th>
      <th scope="col"id="tabla_col_4">Email</th>
      <th scope="col"id="tabla_col_5">Direccion</th>
      <th scope="col"id="tabla_col_6">Telefono</th>
      <th scope="col"id="tabla_col_7">Facebook URL</th>
      <th scope="col"id="tabla_col_8">Twitter URL</th>
      <th scope="col"id="tabla_col_9">Instagram URL</th>
...
<!--   for (Todo todo: todos) {  -->
  <c:forEach var="empresa" items="${listEmpresa}">
         ...
         <tr>
         	<td>
      <c:out value="${empresa.id}" />
       	 	</td>
         	<td>
           <c:out value="${empresa.nombre}" />
         	</td>
         	<td>
            <c:out value="${empresa.quienesS}" />
              </td>
        	 <td>
              <c:out value="${empresa.emailC}" />
        	</td>
         	<td>
           <c:out value="${empresa.direccion}" />
        	</td>
            <td>
        <c:out value="${empresa.telefonoC}" />
        	</td>
        	   <td>
        <c:out value="${empresa.face}" />
        	</td>
        	   <td>
        <c:out value="${empresa.twitt}" />
        	</td>
        	   <td>
